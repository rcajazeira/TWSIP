      ...
      <div class="ism-slider" data-transition_type="zoom" data-image_fx="zoomrotate" id="my-slider">
        <ol>
          <li>
            ...
            <div class="ism-caption ism-caption-0"><button class="adicionar-ao-carrinho" data-produto-id="produto-slider1">Adicionar ao Carrinho</button></div>
            ...
            <div class="coluna">
              ...
              <nav id="menu">
                <div class="produto1">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto1">Adicionar ao Carrinho</button>
                </div>
                <div class="produto2">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto2">Adicionar ao Carrinho</button>
                </div>
              </nav>
            </div>
            <div class="coluna">
              ...
              <nav id="menu">
                <div class="produto3">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto3">Adicionar ao Carrinho</button>
                </div>
                <div class="produto4">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto4">Adicionar ao Carrinho</button>
                </div>
              </nav>
            </div>
            <div class="coluna">
              ...
              <nav id="menu">
                <div class="produto5">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto5">Adicionar ao Carrinho</button>
                </div>
                <div class="produto6">
                  ...
                  <button class="adicionar-ao-carrinho" data-produto-id="produto6">Adicionar ao Carrinho</button>
                </div>
              </nav>
            </div>
          </div>
